...
var Faucet = /** @class */ (function () {
     ...
     */
    Faucet.prototype.claim = function (username, amount) {
        return __awaiter(this, void 0, void 0, function () {
            var response, parsed;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch(this.endpoint + "/Claim", {
                            method: 'POST',
                            headers: {
     ...
     */
    Faucet.prototype.nextClaimTime = function (username) {
        return __awaiter(this, void 0, void 0, function () {
            var response, parsed;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch(this.endpoint + "/" + username + "/NextClaimTime", {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json'
                            },
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, parsed.time]; // Return time
                }
            });
        });
    };
     ...
     * @param username The username of the account to fetch claim details of.
     */
    Faucet.prototype.nextClaimAmount = function (username) {
        return __awaiter(this, void 0, void 0, function () {
            var response, parsed;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch(this.endpoint + "/" + username + "/NextClaimAmount", {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json'
                            },
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, parsed.amount]; // Return amount
                }
            });
        });
    };
